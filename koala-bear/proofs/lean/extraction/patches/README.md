...
From `koala-bear/proofs/lean/extraction` (or run `./proofs/lean/extraction/build-proofs.sh` from the crate root):
...
1. From `koala-bear/proofs/lean/extraction`, `./build-proofs.sh` (or `./proofs/lean/extraction/build-proofs.sh` from the crate root). The patch is missing,
