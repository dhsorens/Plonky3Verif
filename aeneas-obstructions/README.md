...
| --- | --- | --- | --- |
| [2026-08-18](2026-08-18.md) | `daa85d7e` | `340b1af4` (v0.1.232) | **True null delta — a reproducibility control.** Toolchain 0 commits (pull was a no-op, pin unchanged) *and* Plonky3 source 0 commits: every crate reproduces 2026-08-06 **bit-for-bit** — all counts, all obstruction signatures at identical line numbers. No upstream ticket changed state; a dozen new third-party aeneas issues (#1247–#1266) landed, of which #1264 (mixed fun×trait-impl groups) becomes a third partial match for #6. The four unrepresented obstructions (#9 — eleven weeks, #16, #13, #14) remain unfiled; the bottleneck is now filing, not surveying. |
