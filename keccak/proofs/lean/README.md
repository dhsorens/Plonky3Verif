# keccak — Lean extraction via hax's aeneas backend

Extraction of `p3-keccak` through **`cargo hax into lean`** on hax
...
- **Layout:** `P3Keccak/Extraction/{Types,Funs}.lean` are generated;
