#!/usr/bin/env bash
# Regenerate p3_mersenne_31.patch from the current p3_mersenne_31.lean.
#
# Use after hand-editing p3_mersenne_31.lean to make it compile (e.g. after a hax
...
PATCH_FILE="$HERE/p3_mersenne_31.patch"
...
(cd "$HERE" && diff -u "pristine.snapshot.lean" "../p3_mersenne_31.lean") > "$PATCH_FILE" || true
