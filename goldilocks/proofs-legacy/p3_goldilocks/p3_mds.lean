...
-- MDS via circulant FFT (goldilocks). Opaque; the DFT algo is a type+value arg.
opaque apply_circulant_fft (F : Type) (N : usize) (Dft : Type)
  (dft : Dft) (entries : (RustArray u64 N)) (input : (RustArray F N)) :
  RustM (RustArray F N)
