#!/usr/bin/env bash
# Regenerate p3_goldilocks.patch from the current p3_goldilocks.lean.
#
# Use after hand-editing p3_goldilocks.lean to make it compile (e.g. after a hax
...
PATCH_FILE="$HERE/p3_goldilocks.patch"
...
(cd "$HERE" && diff -u "pristine.snapshot.lean" "../p3_goldilocks.lean") > "$PATCH_FILE" || true
