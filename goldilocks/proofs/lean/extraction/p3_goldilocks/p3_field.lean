...
class PrimeCharacteristicRing (R : Type)
  ...
  ZERO (R) : RustM R
  ONE (R) : RustM R
  halve (R) (self : R) : RustM R
  mul_2exp_u64 (R) (self : R) (exp : u64) : RustM R
...
class PrimeField64 (Self : Type)
  ...
  as_canonical_u64 (Self) (self : Self) : RustM u64
  ORDER_U64 (Self) : RustM u64
...
class CubicTrinomialExtendable.AssociatedTypes (Self : Type) where
class CubicTrinomialExtendable (Self : Type)
  [associatedTypes : outParam (CubicTrinomialExtendable.AssociatedTypes Self)] where

class HasTwoAdicCubicExtension.AssociatedTypes (Self : Type) where
class HasTwoAdicCubicExtension (Self : Type)
  [associatedTypes : outParam (HasTwoAdicCubicExtension.AssociatedTypes Self)] where
